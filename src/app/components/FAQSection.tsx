...
const faqs: FAQSectionProps[] = [
    ...
    { question: 'Can I use a pre-existing project I\'m working on?', answer: 'idk lmao' },
    { question: 'What workshops and activities will there be?', answer: 'idk lmao' },
            ...
            <div className={styles.faqContainer}>
                {faqs.map((faq, index) => (
                    <div key={index} className={styles.faqItem}>
                        <div className={styles.faqQuestionContainer} onClick={() => toggleDropdown(index)}>
                            <h4 className={styles.faqQuestion}>
                                {faq.question}
                            </h4>
                            <div className={`${styles.triangle} ${openIndex === index ? styles.open : ''}`}></div>
                        </div>
