      ...
      <div className="flex justify-center items-center  h-full">
        <div className="flex flex-col  text-white w-[full]  justify-center items-center h-full md:flex-row md:p-10">
          <h1 className="flex flex-col text-5xl items-center md:w-[50%]  [text-shadow:_10px_2px_4px_rgb(0_0_0_/_0.3)]  md:text-8xl ">
            <span className="font-jost " style={{ fontSize: "clamp(3rem, 4vw, 9rem)" }}>
              UOTTAHACK
            </span>
            <span
              ref={ref}
              className={`font-bold font-jost text-7xl md:text-8xl ${
          ...
          <div
            ref={ref}
            className={`space-y-10 items-center font-jost md:w-[40%] p-10 mt-10 ${
              isInView
